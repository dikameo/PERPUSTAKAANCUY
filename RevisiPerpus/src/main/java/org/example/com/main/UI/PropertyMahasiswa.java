...
public class PropertyMahasiswa {
    ...
    public PropertyMahasiswa(String name, String nim, String faculty, String programStudi) {
    ...
    public static ArrayList<PropertyMahasiswa> mahasiswaToProperty(ArrayList<Mahasiswa> arr) {
        ...
        for (Mahasiswa mahasiswa : arr) {
            PropertyMahasiswa obj = new PropertyMahasiswa(mahasiswa.getName(), mahasiswa.getNIM(), mahasiswa.getFaculty(), mahasiswa.getProgramStudi());
            temp.add(obj);
        }
        return temp;
    }
